...
//    		struct timeval start_fx;
//    		gettimeofday (&start_fx, NULL);
...
//    struct timeval end_fx;
//    gettimeofday (&end_fx, NULL);
//    std::cout << "pic "<< i << ": " <<  (end_fx.tv_sec-start_fx.tv_sec)+ (end_fx.tv_usec-start_fx.tv_usec)/double(1000*1000) << " s\n" ;
